...
<TABLE class="Ibx_gTable F2Img Ibx_gTable_TT" id=oTableHead>
  ...
  <TR>
    ...
    <TH class=Ibx_Th_From1>简要内容</TH>
    <TH class=Ibx_Th_Date>&nbsp;所属分类</TH>
...
<TABLE class="Ibx_gTable Ibx_gTable_Con" id=oTableCOUNT0 action="list">
  <TBODY>
  <?php if(is_array($diary)): foreach($diary as $key=>$v): ?><TR class="I_Mark0 I_UnRd">
    ...
    title='"Offsetsweden@sharmafields.com" <offsetsweden@sharmafields.com>'><A 
      href="#"><?php echo ($v["talk"]); ?></A></TD>
    <TD class=Ibx_Td_Date title=""><?php echo ($v["cid"]); ?></TD>
    <TD class=Ibx_Td_Subject 
    title=""><?php echo (date("y-m-d H:i",$v["time"])); ?></TD>
    <TD class=Ibx_Td_Size><SPAN title="19,887 字节"><a href="">修改</a>&nbsp;&nbsp;</SPAN><SPAN title="19,887 字节"><a href="">删除</a></SPAN></TD>
