...
<TABLE class="Ibx_gTable F2Img Ibx_gTable_TT" id=oTableHead>
  ...
  <TR>
    ...
    <TH class=Ibx_Th_From1>留言内容</TH>
    <TH class=Ibx_Th_Date>&nbsp;留言者</TH>
    <TH class=Ibx_Th_Subject>留言时间</TH>
...
<TABLE class="Ibx_gTable Ibx_gTable_Con" id=oTableCOUNT0 action="list">
  <TBODY>
  <?php if(is_array($liuyan)): foreach($liuyan as $key=>$v): ?><TR class="I_Mark0 I_UnRd">
    ...
    title='"Offsetsweden@sharmafields.com" <offsetsweden@sharmafields.com>'><A 
      href="#"><?php echo ($v["html"]); echo ($v["content"]); ?></A></TD>
    <TD class=Ibx_Td_Date title=""><?php echo ($v["name"]); ?></TD>
    <TD class=Ibx_Td_Subject 
    title=""><?php echo (date("y-m-d H:i",$v["time"])); ?></TD>
    <TD class=Ibx_Td_Size><SPAN title="19,887 字节"><a href="<?php echo U('List/addList',array('id'=>$v['id']));?>">回复</a>&nbsp;&nbsp;</SPAN><SPAN title="19,887 字节"><a href="<?php echo U('List/delete',array('id'=>$v['id']));?>">删除</a></SPAN></TD>
