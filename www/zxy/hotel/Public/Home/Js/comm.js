function ShowSubMenu(id) //显示下拉
 {
   ...
   switch(submenu_style)
    {
      case 1:
       document.write('<link rel="stylesheet" type="text/css" href="/Hotel/Public/Home/Css/dropmenu.css" />');
...
document.write("<script src=\"/hotel/Public/Home/Js/function.js\" type=\"text/javascript\"></script>");
document.write("<script src=\"/hotel/Public/Home/Js/dialog.js\" type=\"text/javascript\"></script>");                                                                    
