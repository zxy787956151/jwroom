...
<body>
<h2 style="color:white">SEO酒店会员登陆中心</h2>
<div class="row">
  <div class="eightcol last">
    <form id="my-form" action="<?php echo U('Login/runland');?>" method="POST">
        <section name="第一步">
      ...
      <div align="left"><a href="">忘记密码?</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo U('Login/register');?>">重新注册?</a><hr/></div>
      <div>
