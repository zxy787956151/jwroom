...
<li id="sl535"><a href="<?php echo U('Contact/board');?>" class="sla535">留言板</a></li>
</ul>
</div></div>
...
<div class="sublanmu_box sublanmu_box_534">
      <?php if(is_array($board)): foreach($board as $key=>$v): ?><table width="750px" border="0" height="80px">
           <tr height="40px">
           	   <th style="width:120px"><img src="/hotel/Public/Home/Images/ren.jpg"/><?php echo ($v["username"]); ?></th>
           	   <th width="500px" align="left">&nbsp;&nbsp;&nbsp;第<?php echo ($v["id"]); ?>楼</a></th>
           	   <th>引用</th>
           </tr>
           <tr>
           	   <td>&nbsp;</td>
           	   <td colspan='2'>&nbsp;&nbsp;&nbsp;<?php echo ($v["content"]); ?></td>
           </tr>
           <tr><td colspan='2'>&nbsp;&nbsp;&nbsp;<?php echo (date('y-m-d H:i',$v["time"])); ?></td>
               <td>回复</td>
           </tr>
        </table>
