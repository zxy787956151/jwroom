  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      <tr>
        ...
        <td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">级别</span></div></td>
        <td width="30%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">排序</span></div></td>
      ...
      <?php if(is_array($cate)): foreach($cate as $key=>$v): ?><tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><span class="STYLE19"><?php echo ($v["html"]); echo ($v["name"]); ?></span></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($v["level"]); ?></div></td>
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><input type="text" name='<?php echo ($v["id"]); ?>' value='<?php echo ($v["sort"]); ?>'/></div></td>
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><a href="<?php echo U('Category/addCate',array('pid'=>$v['id']));?>">添加子分类</a>&nbsp;|&nbsp;<a href="">修改</a>&nbsp;|&nbsp; <a href="">删除</a></div></td>
