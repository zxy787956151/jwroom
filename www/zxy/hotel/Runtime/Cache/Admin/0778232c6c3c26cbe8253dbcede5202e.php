  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      <tr>
        ...
        <td width="30%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">标题</span></div></td>
        <td width="20%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">发布时间</span></div></td>
        <td width="35%" height="20" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">操作</span></div></td>
      </tr>
      <?php if(is_array($news)): foreach($news as $key=>$v): ?><tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo (date('m-d H:i',$v["time"])); ?></div></td>
        <?php if(ACTION_NAME == "index"): ?><td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><a href="">修改</a>&nbsp;|&nbsp; <a href="<?php echo U('News/update',array('id'=>$v['id'],'type'=>1));?>">删除</a></div></td>
        <?php else: ?>
        <td height="20" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><a href="<?php echo U('News/update',array('id'=>$v['id'],'type'=>0));?>">还原</a>&nbsp;|&nbsp; <a href="<?php echo U('News/drop',array('id'=>$v['id']));?>">彻底删除</a></div></td><?php endif; ?>
      </tr><?php endforeach; endif; ?>
    </table></td>
  </tr>
  <?php if(ACTION_NAME == "index"): ?><tr></tr>
        <?php else: ?>
            <tr><td colspan='6' align="center"><a href="<?php echo U('News/clear');?>"><input type="button" value="清空回收站"/></a></td>
            </tr><?php endif; ?>
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
    </table></td>
